Feature: Filter on Careers page
  ...
  Scenario: Refreshing a page after filtration
    When I type "javascript" in the "Keyword" field
    And I click the Find button
    And I remember "Filter result heading" from filter
  ...
  Scenario: Visiting a job page
    When I type "javascript" in the "Keyword" field
    And I click the Find button
    And I remember "Name of the first appeared job opening" from filter
    And I click the first appeared job opening
    Then "name of the job opening on the job page" equals remembered from filter "name of the job opening"